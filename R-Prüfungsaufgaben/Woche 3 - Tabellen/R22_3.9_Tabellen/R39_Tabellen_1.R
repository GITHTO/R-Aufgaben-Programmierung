...
nur_vers <- function(df) {
  subset(df, Species == "versicolor") ### Schreibweise beachten Subset gibt Teil aus DaSa an je nach Beding.
}
...
phones_zeilen_sd <- apply(WorldPhones, MARGIN = 1, sd)
### Margin = 1 Zeile 2 = Spalte apply gibt erg zurück der Zeile/Spalte
