...
### startsWith filtert im z fake heraus, gsub ersetzt dummy mit --, nchar macht leere einträge --> ausgabe return(z)
...
# A7 ----
### tapply funktion wendet in diesen fall median auf die Werte des Vektors an nach Gruppen
