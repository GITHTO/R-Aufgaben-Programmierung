...
# t1_start
plot(airquality$Temp,airquality$Ozone, data=airquality, las=1, 
     pch=16, col="#FFA50080", bg="#FFA50080",
     xlab = "Temperatur  [\U{00B0}Fahrenheit]",
     ylab = "\U{00D8} Ozon  [ppb]", 
     xlim = c(50,100), cex=(airquality$Wind/5),
...
# t3_start
abline(h = mean(airquality$Ozone, na.rm = TRUE), lty = 2, col="green")
##abline(h = mean(42.12931), lty = 2, col = "blue") 
# t3_ende
...
legend("topleft", legend = leg_wind, title = "Windgeschwindigkeit  [mph]", 
       pch = 16, pt.cex = leg_wind/5, col = "orange")
# t5_ende ### pt.cex Größe der Symbole in der legendfunktion
